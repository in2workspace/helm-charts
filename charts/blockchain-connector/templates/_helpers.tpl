...
{{ include "blockchain-connector.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "blockchain-connector.selectorLabels" -}}
...
*/}}
{{- define "blockchain-connector.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "blockchain-connector.fullname" .) .Values.serviceAccount.name }}
{{- else }}
