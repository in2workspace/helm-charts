...
*/}}
{{- define "dome-wallet-api.fullname" -}}
...
Common labels
*/}}
{{- define "dome-wallet-api.labels" -}}
helm.sh/chart: {{ include "dome-wallet-api.chart" . }}
{{ include "dome-wallet-api.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "dome-wallet-api.selectorLabels" -}}
app.kubernetes.io/name: {{ include "dome-wallet-api.name" . }}
...
*/}}
{{- define "dome-wallet-api.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "dome-wallet-api.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "dome-wallet-api.clientSecretName" -}}
    {{- if .Values.app.ebsiTest.client.existingSecret.enabled -}}
        {{- printf "%s" (tpl .Values.app.ebsiTest.client.existingSecret.name $) -}}
    {{- else -}}
        {{- printf "dome-wallet-api-client-secret" -}}
    {{- end -}}
{{- end -}}

{{- define "dome-wallet-api.client-passwordKey" -}}
    {{- if .Values.app.ebsiTest.client.existingSecret.enabled -}}
...
{{- define "dome-wallet-api.userSecretName" -}}
...
{{- define "dome-wallet-api.user-passwordKey" -}}
    {{- if .Values.app.ebsiTest.userData.existingSecret.enabled -}}
...
{{- define "dome-wallet-api.vaultTokenSecretName" -}}
...
{{- define "dome-wallet-api.user-tokenKey" -}}
    {{- if .Values.app.vault.existingSecret.enabled -}}
...
Support for existing database secret
*/}}
{{- define "dome-wallet-api.db-secretName" -}}
...
{{- define "dome-wallet-api.db-passwordKey" -}}
    {{- if .Values.db.existingSecret.enabled -}}
