...
*/}}
{{- define "eudistack-issuer-enterprise-backend.db-secretName" -}}
...
{{- define "eudistack-issuer-enterprise-backend.db-passwordKey" -}}
    {{- if .Values.app.db.existingSecret.enabled -}}
...
*/}}
{{- define "eudistack-issuer-enterprise-backend.authServerClient-secretName" -}}
...
{{- define "eudistack-issuer-enterprise-backend.authServerClient-passwordKey" -}}
    {{- if .Values.app.authServer.client.existingSecret.enabled -}}
...
*/}}
{{- define "eudistack-issuer-enterprise-backend.mail-secretName" -}}
...
{{- define "eudistack-issuer-enterprise-backend.mail-userKey" -}}
    {{- if .Values.app.mail.existingSecret.enabled -}}
...
{{- define "eudistack-issuer-enterprise-backend.mail-passwordKey" -}}
    {{- if .Values.app.mail.existingSecret.enabled -}}
...
*/}}
{{- define "eudistack-issuer-enterprise-backend.issuerIdentity-secretName" -}}
...
{{- define "eudistack-issuer-enterprise-backend.issuerIdentity-privateKey" -}}
    {{- if .Values.app.issuerIdentity.existingSecret.enabled -}}
...
{{- define "eudistack-issuer-enterprise-backend.issuerIdentity-vc" -}}
    {{- if .Values.app.issuerIdentity.existingSecret.enabled -}}
...
{{- define "eudistack-issuer-enterprise-backend.issuerIdentity-credentialDidKey" -}}
    {{- if .Values.app.issuerIdentity.existingSecret.enabled -}}
...
*/}}
{{- define "eudistack-issuer-enterprise-backend.defaultSigner-secretName" -}}
...
{{- define "eudistack-issuer-enterprise-backend.defaultSigner-commonName" -}}
    {{- if .Values.app.defaultSigner.existingSecret.enabled -}}
...
{{- define "eudistack-issuer-enterprise-backend.defaultSigner-organization" -}}
    {{- if .Values.app.defaultSigner.existingSecret.enabled -}}
...
{{- define "eudistack-issuer-enterprise-backend.defaultSigner-country" -}}
    {{- if .Values.app.defaultSigner.existingSecret.enabled -}}
...
{{- define "eudistack-issuer-enterprise-backend.defaultSigner-email" -}}
    {{- if .Values.app.defaultSigner.existingSecret.enabled -}}
...
{{- define "eudistack-issuer-enterprise-backend.defaultSigner-organizationIdentifier" -}}
    {{- if .Values.app.defaultSigner.existingSecret.enabled -}}
...
{{- define "eudistack-issuer-enterprise-backend.defaultSigner-serialNumber" -}}
    {{- if .Values.app.defaultSigner.existingSecret.enabled -}}
...
*/}}
{{- define "eudistack-issuer-enterprise-backend.vaultTokenSecretName" -}}
...
{{- define "eudistack-issuer-enterprise-backend.vaultTokenSecretKey" -}}
  {{- if .Values.app.vault.existingSecret.enabled -}}
