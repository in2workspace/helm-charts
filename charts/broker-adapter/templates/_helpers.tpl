...
{{ include "broker-adapter.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "broker-adapter.selectorLabels" -}}
...
*/}}
{{- define "broker-adapter.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "broker-adapter.fullname" .) .Values.serviceAccount.name }}
{{- else }}
